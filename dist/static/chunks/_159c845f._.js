(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_159c845f._.js", {
...
class AuthService {
    ...
    isWebAuthnSupported() {
        return "object" !== 'undefined' && window.PublicKeyCredential !== undefined && navigator.credentials !== undefined;
    }
...
function LoginPage() {
    ...
    const [isWebAuthnSupported, setIsWebAuthnSupported] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const mainHeadingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            ...
            // Check if WebAuthn is supported
            setIsWebAuthnSupported(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].isWebAuthnSupported());
            // Redirect if already authenticated
            if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].isAuthenticated()) {
                router.push('/');
            }
        }
    }["LoginPage.useEffect"], [
    ...
    const handleWebAuthnRegister = async ()=>{
        ...
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].registerWithWebAuthn(username.trim());
            if (user) {
                router.push('/');
            } else {
    ...
    const handleWebAuthnLogin = async ()=>{
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].authenticateWithWebAuthn();
            if (user) {
                router.push('/');
            } else {
    ...
    const handlePINLogin = ()=>{
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].verifyPIN(pin.trim())) {
    ...
    const handleSetPIN = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].setPIN(pin.trim());
...
_s(LoginPage, "v+/Qxme0ifALHwmMH+Al/ARKqvU=", false, function() {
    return [
...
//# sourceMappingURL=_159c845f._.js.map